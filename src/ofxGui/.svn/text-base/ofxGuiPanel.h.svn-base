...
public:
	...
	void			init(int id, string name, int x, int y, int border, int spacing, bool alignToRight = false);
	...
	ofxGuiObject*	addButton(int id, string name, int width, int height, bool value, int display, bool alignToRight = false);
	...
	ofxGuiObject*	addSwitch(int id, string name, int width, int height,  int min, int max, int value, const string* paramStrings, bool alignToRight = false);
